...
export function EmailNotificationSettings({ onUnauthorized }: EmailNotificationSettingsProps) {
  ...
  return (
    <div className="space-y-3 rounded-xl border border-border/60 bg-muted/20 p-3.5 shadow-xs transition-[border-color] duration-200 hover:border-border sm:space-y-4 sm:p-5">
